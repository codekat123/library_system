...
SECRET_KEY = 'django-insecure-+qt5g1=d8^mqotip+p&&nh!59ojppxkdujh082&=*s9t(s=u@k'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'lms_app.context_processors.sidebar_data',
            ],
        },
    },
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
               os.path.join(BASE_DIR, 'library_system', 'static') 
]
# Media
